...
def build_business_plan_pdf(bp: Any, meta: dict | None = None) -> BytesIO:
    ...
    story.append(Paragraph(_clean(
        T("Valori in € correnti. EBITDA = Ricavi − OPEX. CFO = EBITDA − "
          "imposte. FCF equity = CFO − rata capitale − interessi. NPV e IRR "
          "di progetto su flussi unlevered (al netto del PNRR); payback e IRR "
          "equity su flussi levered. Documento generato da "
          ...
          "taxes. Equity FCF = CFO − principal − interest. Project NPV and IRR "
          "on unlevered flows (net of PNRR); equity payback and IRR on levered "
          "flows. Generated by Metan.iQ; figures depend "
