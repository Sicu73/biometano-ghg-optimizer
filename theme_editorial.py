...
.stApp h1, .stApp h2, .stApp h3, .stApp h4 {{ font-family:'Spectral', Georgia, serif !important; font-weight:600 !important; letter-spacing:-.01em !important; color:{t['INK']} !important; }}
.stMarkdown p, label, .stApp p, li {{ color:{t['INK']} !important; }}
...
section[data-testid="stSidebar"] h1, section[data-testid="stSidebar"] h2, section[data-testid="stSidebar"] h3 {{ font-family:'Spectral', serif !important; color:{t['INK']} !important; }}
