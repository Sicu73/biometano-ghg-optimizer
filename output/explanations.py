...
_REGULATORY_BASIS_IT = (
    ...
    "- DM 18/09/2024 (FER 2): biogas CHP piccoli impianti ≤300 kWe, "
    "Tariffa di Riferimento + premi matrice/CAR, 20 anni.\n"
...
_REGULATORY_BASIS_EN = (
    ...
    "- DM 18/09/2024 (FER 2): small CHP biogas ≤300 kWe, "
    "Reference Tariff + matrix/CAR bonuses, 20 years.\n"
