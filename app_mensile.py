...
# ============================================================
# DATABASE FEEDSTOCK
# Single source of truth: core/feedstock_db.py (42 biomasse).
# Storicamente inline qui (~340 LOC); estratto 2026-06-06 per
# disaccoppiare la UI Streamlit dal catalogo dati normativi e
# aprire la strada al passaggio a data/feedstocks.json (futuro).
# Convenzione: manure credit RED III (-45 gCO2/MJ) incorporato
# direttamente nell'eec, come da prassi GSE LG 2024.
# ============================================================
from core.feedstock_db import FEEDSTOCK_DB  # noqa: E402
