...
Strategia proxy (fase 1):
  ...
  - In fase 2 (migrazione progressiva) le funzioni verranno spostate
    fisicamente qui e app_mensile importera' da core/.
...
# ---------------------------------------------------------------------------
# Import da app_mensile (proxy pattern).
# Se app_mensile non e' disponibile (es. test isolati senza Streamlit)
# ricadiamo su implementazioni minimali che non rompono i test.
# ---------------------------------------------------------------------------
try:
    from app_mensile import (  # type: ignore[import]
    ...
    # --- Fallback minimali per test isolati ---
    import numpy as np
